...
<html>
<head>
    <title><fmt:message key="label.admin.cities.create" bundle="${ rb }" /></title>
    <meta charset="utf-8">
...
<section>
    <div class="container-fluid">
        <span style="text-align: center;"><h1><fmt:message key="label.admin.cities.create" bundle="${ rb }" /></h1></span>
        <ctg:before-grid />
        <form id="create-trip-form" method="post" action="travel" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            <div class="row">
                <div class="col-sm-2 col-sm-offset-5">
                    <c:choose>
                        <c:when test="${ not empty errorCreateCityPassMessage }">
                            <br/>
                            <span style="color: #ff0000;">${errorCreateCityPassMessage}</span>
                            <br/>
                            <br/>
                        </c:when>
                        <c:otherwise>
