...
<html>
<head>
    <title><fmt:message key="title.admin.country-list" bundle="${ rb }" /></title>
    <meta charset="utf-8">
...
<section>
    <div class="container-fluid">
        <span style="text-align: center;"><h1><fmt:message key="title.admin.country-list" bundle="${ rb }" /></h1></span>
        <ctg:before-grid />
        <ctg:vacation-table>
        <tr>
